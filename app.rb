...
post "/commits_to_send" do
    ...
    erb :visualization, locals:{comments:comments,info:info, clients:client_repo, comments:comments, hours:session[:client_to_hour], name:session[:users_fullname], weeks:session[:split_weeks], hours_total:session[:weeks_total], wage:session[:hourly_rate], billed:client_billing}
end